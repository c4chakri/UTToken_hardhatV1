...
contract UTtokenUpgradeableV2 is ERC20Upgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable,OwnableUpgradeable ,UUPSUpgradeable{
 ...
 function initialize(
        ...
        __ERC20_init(_tokenName, _tokenTicker);
        __Pausable_init();
